...
public class BatchTests extends AbstractBootYarnClusterTests {
	...
	public void testAppSubmission() throws Exception {
		String[] args = new String[] {
				"--spring.yarn.client.files[0]=file:build/libs/batch-restart-db-boot-appmaster-2.0.0.BUILD-SNAPSHOT.jar",
				"--spring.yarn.client.files[1]=file:build/libs/batch-restart-db-boot-container-2.0.0.BUILD-SNAPSHOT.jar" };

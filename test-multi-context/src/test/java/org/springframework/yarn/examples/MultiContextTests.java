...
public class MultiContextTests extends AbstractBootYarnClusterTests {
	...
	public void testAppSubmission() throws Exception {
		...
		String[] args = new String[]{
				"--spring.yarn.client.files[0]=file:build/libs/test-multi-context-appmaster-2.0.0.BUILD-SNAPSHOT.jar",
				"--spring.yarn.client.files[1]=file:build/libs/test-multi-context-container-2.0.0.BUILD-SNAPSHOT.jar"
		};
